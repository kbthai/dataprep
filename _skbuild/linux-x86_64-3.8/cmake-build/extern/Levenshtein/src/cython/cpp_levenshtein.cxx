...
/* Python wrapper */
static PyObject *__pyx_pw_15cpp_levenshtein_1inverse(PyObject *__pyx_self, PyObject *__pyx_v_edit_operations); /*proto*/
static char __pyx_doc_15cpp_levenshtein_inverse[] = "\n    Invert the sense of an edit operation sequence.\n\n    In other words, it returns a list of edit operations transforming the\n    second (destination) string to the first (source).  It can be used\n    with both editops and opcodes.\n\n    Parameters\n    ----------\n    edit_operations : list[]\n        edit operations to invert\n\n    Returns\n    -------\n    edit_operations : list[]\n        inverted edit operations\n\n    Examples\n    --------\n    >>> inverse(editops('spam', 'park'))\n    [('insert', 0, 0), ('delete', 2, 3), ('replace', 3, 3)]\n    >>> editops('park', 'spam')\n    [('insert', 0, 0), ('delete', 2, 3), ('replace', 3, 3)]\n    ";
static PyMethodDef __pyx_mdef_15cpp_levenshtein_1inverse = {"inverse", (PyCFunction)__pyx_pw_15cpp_levenshtein_1inverse, METH_O, __pyx_doc_15cpp_levenshtein_inverse};
static PyObject *__pyx_pw_15cpp_levenshtein_1inverse(PyObject *__pyx_self, PyObject *__pyx_v_edit_operations) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inverse (wrapper)", 0);
  __pyx_r = __pyx_pf_15cpp_levenshtein_inverse(__pyx_self, ((PyObject *)__pyx_v_edit_operations));
 ...
 */
  if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 248, __pyx_L1_error)
 ...
 */
  if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 255, __pyx_L1_error)
...
static char __pyx_doc_15cpp_levenshtein_2editops[] = "\n    Find sequence of edit operations transforming one string to another.\n    \n    editops(source_string, destination_string)\n    editops(edit_operations, source_length, destination_length)\n    \n    The result is a list of triples (operation, spos, dpos), where\n    operation is one of 'equal', 'replace', 'insert', or 'delete';  spos\n    and dpos are position of characters in the first (source) and the\n    second (destination) strings.  These are operations on signle\n    characters.  In fact the returned list doesn't contain the 'equal',\n    but all the related functions accept both lists with and without\n    'equal's.\n    \n    Examples\n    --------\n    >>> editops('spam', 'park')\n    [('delete', 0, 0), ('insert', 3, 2), ('replace', 3, 3)]\n    \n    The alternate form editops(opcodes, source_string, destination_string)\n    can be used for conversion from opcodes (5-tuples) to editops (you can\n    pass strings or their lengths, it doesn't matter).\n    ";
...
static PyObject *__pyx_pw_15cpp_levenshtein_3editops(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds) && unlikely(PyDict_Size(__pyx_kwds) > 0) && unlikely(!__Pyx_CheckKeywordStrings(__pyx_kwds, "editops", 0))) return NULL;
 ...
 */
    ...
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[4] = {__pyx_t_9, __pyx_v_arg1, __pyx_t_7, __pyx_t_8};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_10, 3+__pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 302, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[4] = {__pyx_t_9, __pyx_v_arg1, __pyx_t_7, __pyx_t_8};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_10, 3+__pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 302, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    ...
    #endif
    {
      __pyx_t_11 = PyTuple_New(3+__pyx_t_10); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 302, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      if (__pyx_t_9) {
      ...
      PyTuple_SET_ITEM(__pyx_t_11, 0+__pyx_t_10, __pyx_v_arg1);
      __Pyx_GIVEREF(__pyx_t_7);
      ...
      __pyx_t_7 = 0;
      __pyx_t_8 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_11, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 302, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  if (PyFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_11, __pyx_v_arg1, __pyx_v_arg2};
    __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_10, 2+__pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 306, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_11, __pyx_v_arg1, __pyx_v_arg2};
    __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_10, 2+__pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 306, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else
  #endif
  {
    __pyx_t_8 = PyTuple_New(2+__pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 306, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    if (__pyx_t_11) {
    ...
    __Pyx_INCREF(__pyx_v_arg1);
    __Pyx_GIVEREF(__pyx_v_arg1);
    PyTuple_SET_ITEM(__pyx_t_8, 0+__pyx_t_10, __pyx_v_arg1);
    __Pyx_INCREF(__pyx_v_arg2);
    __Pyx_GIVEREF(__pyx_v_arg2);
    PyTuple_SET_ITEM(__pyx_t_8, 1+__pyx_t_10, __pyx_v_arg2);
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_8, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 306, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static char __pyx_doc_15cpp_levenshtein_4opcodes[] = "\n    Find sequence of edit operations transforming one string to another.\n    \n    opcodes(source_string, destination_string)\n    opcodes(edit_operations, source_length, destination_length)\n    \n    The result is a list of 5-tuples with the same meaning as in\n    SequenceMatcher's get_opcodes() output.  But since the algorithms\n    differ, the actual sequences from Levenshtein and SequenceMatcher\n    may differ too.\n    \n    Examples\n    --------\n    >>> for x in opcodes('spam', 'park'):\n    ...     print(x)\n    ...\n    ('delete', 0, 1, 0, 0)\n    ('equal', 1, 3, 0, 2)\n    ('insert', 3, 3, 2, 3)\n    ('replace', 3, 4, 3, 4)\n    \n    The alternate form opcodes(editops, source_string, destination_string)\n    can be used for conversion from editops (triples) to opcodes (you can\n    pass strings or their lengths, it doesn't matter).\n    ";
...
static PyObject *__pyx_pw_15cpp_levenshtein_5opcodes(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds) && unlikely(PyDict_Size(__pyx_kwds) > 0) && unlikely(!__Pyx_CheckKeywordStrings(__pyx_kwds, "opcodes", 0))) return NULL;
  __Pyx_INCREF(__pyx_args);
  __pyx_v_args = __pyx_args;
 ...
 */
    ...
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[4] = {__pyx_t_9, __pyx_v_arg1, __pyx_t_7, __pyx_t_8};
      __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_10, 3+__pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 347, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[4] = {__pyx_t_9, __pyx_v_arg1, __pyx_t_7, __pyx_t_8};
      __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_10, 3+__pyx_t_10); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 347, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    ...
    #endif
    {
      __pyx_t_11 = PyTuple_New(3+__pyx_t_10); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 347, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      if (__pyx_t_9) {
        __Pyx_GIVEREF(__pyx_t_9); PyTuple_SET_ITEM(__pyx_t_11, 0, __pyx_t_9); __pyx_t_9 = NULL;
      }
      ...
      __pyx_t_7 = 0;
      __pyx_t_8 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_11, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 347, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
    }
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  if (PyFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_11, __pyx_v_arg1, __pyx_v_arg2};
    __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_10, 2+__pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 351, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else
  #endif
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_11, __pyx_v_arg1, __pyx_v_arg2};
    __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_10, 2+__pyx_t_10); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 351, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_11); __pyx_t_11 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else
  #endif
  {
    __pyx_t_8 = PyTuple_New(2+__pyx_t_10); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 351, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    if (__pyx_t_11) {
      __Pyx_GIVEREF(__pyx_t_11); PyTuple_SET_ITEM(__pyx_t_8, 0, __pyx_t_11); __pyx_t_11 = NULL;
    }
    ...
    __Pyx_GIVEREF(__pyx_v_arg2);
    PyTuple_SET_ITEM(__pyx_t_8, 1+__pyx_t_10, __pyx_v_arg2);
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_8, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 351, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  }
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_15cpp_levenshtein_7matching_blocks(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_15cpp_levenshtein_6matching_blocks[] = "\n    Find identical blocks in two strings.\n\n    Parameters\n    ----------\n    edit_operations : list[]\n        editops or opcodes created for the source and destination string\n    source_string : str | int\n        source string or the length of the source string\n    destination_string : str | int\n        destination string or the length of the destination string\n\n    Returns\n    -------\n    matching_blocks : list[]\n        List of triples with the same meaning as in SequenceMatcher's\n        get_matching_blocks() output.\n\n    Examples\n    --------\n    >>> a, b = 'spam', 'park'\n    >>> matching_blocks(editops(a, b), a, b)\n    [(1, 0, 2), (4, 4, 0)]\n    >>> matching_blocks(editops(a, b), len(a), len(b))\n    [(1, 0, 2), (4, 4, 0)]\n    \n    The last zero-length block is not an error, but it's there for\n    compatibility with difflib which always emits it.\n    \n    One can join the matching blocks to get two identical strings:\n\n    >>> a, b = 'dog kennels', 'mattresses'\n    >>> mb = matching_blocks(editops(a,b), a, b)\n    >>> ''.join([a[x[0]:x[0]+x[2]] for x in mb])\n    'ees'\n    >>> ''.join([b[x[1]:x[1]+x[2]] for x in mb])\n    'ees'\n    ";
static PyMethodDef __pyx_mdef_15cpp_levenshtein_7matching_blocks = {"matching_blocks", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15cpp_levenshtein_7matching_blocks, METH_VARARGS|METH_KEYWORDS, __pyx_doc_15cpp_levenshtein_6matching_blocks};
static PyObject *__pyx_pw_15cpp_levenshtein_7matching_blocks(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("matching_blocks (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_edit_operations)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_source_string)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matching_blocks", 1, 3, 3, 1); __PYX_ERR(0, 354, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_destination_string)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matching_blocks", 1, 3, 3, 2); __PYX_ERR(0, 354, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "matching_blocks") < 0)) __PYX_ERR(0, 354, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("matching_blocks", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 354, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 408, __pyx_L1_error)
 ...
 */
  if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 423, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_15cpp_levenshtein_9subtract_edit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_15cpp_levenshtein_8subtract_edit[] = "\n    Subtract an edit subsequence from a sequence.\n    \n    subtract_edit(edit_operations, subsequence)\n    \n    The result is equivalent to\n    editops(apply_edit(subsequence, s1, s2), s2), except that is\n    constructed directly from the edit operations.  That is, if you apply\n    it to the result of subsequence application, you get the same final\n    string as from application complete edit_operations.  It may be not\n    identical, though (in amibuous cases, like insertion of a character\n    next to the same character).\n    \n    The subtracted subsequence must be an ordered subset of\n    edit_operations.\n    \n    Note this function does not accept difflib-style opcodes as no one in\n    his right mind wants to create subsequences from them.\n\n    Examples\n    --------\n    >>> e = editops('man', 'scotsman')\n    >>> e1 = e[:3]\n    >>> bastard = apply_edit(e1, 'man', 'scotsman')\n    >>> bastard\n    'scoman'\n    >>> apply_edit(subtract_edit(e, e1), bastard, 'scotsman')\n    'scotsman'\n    ";
static PyMethodDef __pyx_mdef_15cpp_levenshtein_9subtract_edit = {"subtract_edit", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15cpp_levenshtein_9subtract_edit, METH_VARARGS|METH_KEYWORDS, __pyx_doc_15cpp_levenshtein_8subtract_edit};
static PyObject *__pyx_pw_15cpp_levenshtein_9subtract_edit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_edit_operations = 0;
  ...
  __Pyx_RefNannySetupContext("subtract_edit (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_subsequence)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("subtract_edit", 1, 2, 2, 1); __PYX_ERR(0, 441, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "subtract_edit") < 0)) __PYX_ERR(0, 441, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("subtract_edit", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 441, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 487, __pyx_L1_error)
 ...
 */
    if (!(likely(PyList_CheckExact(__pyx_v_subsequence))||((__pyx_v_subsequence) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_subsequence)->tp_name), 0))) __PYX_ERR(0, 489, __pyx_L1_error)
...
/* Python wrapper */
static PyObject *__pyx_pw_15cpp_levenshtein_11apply_edit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_15cpp_levenshtein_10apply_edit[] = "\n    Apply a sequence of edit operations to a string.\n    \n    apply_edit(edit_operations, source_string, destination_string)\n    \n    In the case of editops, the sequence can be arbitrary ordered subset\n    of the edit sequence transforming source_string to destination_string.\n    \n    Examples\n    --------\n    >>> e = editops('man', 'scotsman')\n    >>> apply_edit(e, 'man', 'scotsman')\n    'scotsman'\n    >>> apply_edit(e[:3], 'man', 'scotsman')\n    'scoman'\n    \n    The other form of edit operations, opcodes, is not very suitable for\n    such a tricks, because it has to always span over complete strings,\n    subsets can be created by carefully replacing blocks with 'equal'\n    blocks, or by enlarging 'equal' block at the expense of other blocks\n    and adjusting the other blocks accordingly.\n\n    >>> a, b = 'spam and eggs', 'foo and bar'\n    >>> e = opcodes(a, b)\n    >>> apply_edit(inverse(e), b, a)\n    'spam and eggs'\n    >>> e[4] = ('equal', 10, 13, 8, 11)\n    >>> e\n    [('delete', 0, 1, 0, 0), ('replace', 1, 4, 0, 3), ('equal', 4, 9, 3, 8), ('delete', 9, 10, 8, 8), ('equal', 10, 13, 8, 11)]\n    >>> apply_edit(e, a, b)\n    'foo and ggs'\n    ";
static PyMethodDef __pyx_mdef_15cpp_levenshtein_11apply_edit = {"apply_edit", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_15cpp_levenshtein_11apply_edit, METH_VARARGS|METH_KEYWORDS, __pyx_doc_15cpp_levenshtein_10apply_edit};
static PyObject *__pyx_pw_15cpp_levenshtein_11apply_edit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_edit_operations = 0;
  PyObject *__pyx_v_source_string = 0;
  PyObject *__pyx_v_destination_string = 0;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("apply_edit (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "apply_edit") < 0)) __PYX_ERR(0, 508, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("apply_edit", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 508, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *             if lev_editops_check_errors(len1, len2, n, ops):
 */
    if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 560, __pyx_L1_error)
 ...
 *             if lev_opcodes_check_errors(len1, len2, n, bops):
 */
    if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 576, __pyx_L1_error)
 ...
 *             if lev_editops_check_errors(len1, len2, n, ops):
 */
    if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 604, __pyx_L1_error)
 ...
 *             if lev_opcodes_check_errors(len1, len2, n, bops):
 */
    if (!(likely(PyList_CheckExact(__pyx_v_edit_operations))||((__pyx_v_edit_operations) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "list", Py_TYPE(__pyx_v_edit_operations)->tp_name), 0))) __PYX_ERR(0, 620, __pyx_L1_error)
 ...
 *     Invert the sense of an edit operation sequence.
 */
  __pyx_tuple__14 = PyTuple_Pack(5, __pyx_n_s_edit_operations, __pyx_n_s_n, __pyx_n_s_ops, __pyx_n_s_bops, __pyx_n_s_result); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 212, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(1, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_danrui_Dataprep_pre_compil, __pyx_n_s_inverse, 212, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 212, __pyx_L1_error)
 ...
 *     Find sequence of edit operations transforming one string to another.
 */
  __pyx_tuple__16 = PyTuple_Pack(9, __pyx_n_s_args, __pyx_n_s_n, __pyx_n_s_len1, __pyx_n_s_len2, __pyx_n_s_ops, __pyx_n_s_bops, __pyx_n_s_arg1, __pyx_n_s_arg2, __pyx_n_s_arg3); if (unlikely(!__pyx_tuple__16)) __PYX_ERR(0, 266, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__16);
  __Pyx_GIVEREF(__pyx_tuple__16);
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(0, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARARGS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_danrui_Dataprep_pre_compil, __pyx_n_s_editops, 266, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) __PYX_ERR(0, 266, __pyx_L1_error)
 ...
 *     Find sequence of edit operations transforming one string to another.
 */
  __pyx_tuple__18 = PyTuple_Pack(10, __pyx_n_s_args, __pyx_n_s_n, __pyx_n_s_nb, __pyx_n_s_len1, __pyx_n_s_len2, __pyx_n_s_ops, __pyx_n_s_bops, __pyx_n_s_arg1, __pyx_n_s_arg2, __pyx_n_s_arg3); if (unlikely(!__pyx_tuple__18)) __PYX_ERR(0, 309, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__18);
  __Pyx_GIVEREF(__pyx_tuple__18);
  __pyx_codeobj__19 = (PyObject*)__Pyx_PyCode_New(0, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS|CO_VARARGS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__18, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_danrui_Dataprep_pre_compil, __pyx_n_s_opcodes, 309, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__19)) __PYX_ERR(0, 309, __pyx_L1_error)
 ...
 *     Find identical blocks in two strings.
 */
  __pyx_tuple__20 = PyTuple_Pack(11, __pyx_n_s_edit_operations, __pyx_n_s_source_string, __pyx_n_s_destination_string, __pyx_n_s_n, __pyx_n_s_nmb, __pyx_n_s_len1, __pyx_n_s_len2, __pyx_n_s_ops, __pyx_n_s_bops, __pyx_n_s_mblocks, __pyx_n_s_result); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 354, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(3, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_danrui_Dataprep_pre_compil, __pyx_n_s_matching_blocks, 354, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 354, __pyx_L1_error)
 ...
 *     Subtract an edit subsequence from a sequence.
 */
  __pyx_tuple__22 = PyTuple_Pack(9, __pyx_n_s_edit_operations, __pyx_n_s_subsequence, __pyx_n_s_n, __pyx_n_s_ns, __pyx_n_s_nr, __pyx_n_s_ops, __pyx_n_s_osub, __pyx_n_s_orem, __pyx_n_s_result); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 441, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(2, 0, 9, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_danrui_Dataprep_pre_compil, __pyx_n_s_subtract_edit, 441, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 441, __pyx_L1_error)
...
#endif
{
  ...
  __pyx_t_15cpp_levenshtein_OpcodeName __pyx_t_3;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannyDeclarations
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_Editops);
  __Pyx_INCREF(__pyx_n_s_Opcodes);
  __Pyx_GIVEREF(__pyx_n_s_Opcodes);
  PyList_SET_ITEM(__pyx_t_1, 1, __pyx_n_s_Opcodes);
 ...
 *     Opcodes as RfOpcodes
 */
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_rapidfuzz_distance, __pyx_t_1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_Editops); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RfEditops, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_Opcodes); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_RfOpcodes, __pyx_t_1) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     opcodes as rf_opcodes
 */
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_rapidfuzz_distance_Levenshtein, __pyx_t_2, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_editops); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rf_editops, __pyx_t_2) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_ImportFrom(__pyx_t_1, __pyx_n_s_opcodes); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_rf_opcodes, __pyx_t_2) < 0) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  __pyx_t_3.pystring = ((PyObject *)__pyx_n_u_equal);
  __pyx_t_3.cstring = ((char const *)"equal");
  __pyx_t_3.len = strlen(((char const *)"equal"));
  (__pyx_v_15cpp_levenshtein_opcode_names[0]) = __pyx_t_3;
 ...
 */
  __pyx_t_3.pystring = ((PyObject *)__pyx_n_u_replace);
  __pyx_t_3.cstring = ((char const *)"replace");
  __pyx_t_3.len = strlen(((char const *)"replace"));
  (__pyx_v_15cpp_levenshtein_opcode_names[1]) = __pyx_t_3;
 ...
 * cdef size_t N_OPCODE_NAMES = 4
 */
  __pyx_t_3.pystring = ((PyObject *)__pyx_n_u_insert);
  __pyx_t_3.cstring = ((char const *)"insert");
  __pyx_t_3.len = strlen(((char const *)"insert"));
  (__pyx_v_15cpp_levenshtein_opcode_names[2]) = __pyx_t_3;
 ...
 * 
 */
  __pyx_t_3.pystring = ((PyObject *)__pyx_n_u_delete);
  __pyx_t_3.cstring = ((char const *)"delete");
  __pyx_t_3.len = strlen(((char const *)"delete"));
  (__pyx_v_15cpp_levenshtein_opcode_names[3]) = __pyx_t_3;
 ...
 *     Invert the sense of an edit operation sequence.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_1inverse, 0, __pyx_n_s_inverse, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__15)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 212, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_inverse, __pyx_t_1) < 0) __PYX_ERR(0, 212, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Find sequence of edit operations transforming one string to another.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_3editops, 0, __pyx_n_s_editops, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__17)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 266, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_editops, __pyx_t_1) < 0) __PYX_ERR(0, 266, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Find sequence of edit operations transforming one string to another.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_5opcodes, 0, __pyx_n_s_opcodes, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__19)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 309, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_opcodes, __pyx_t_1) < 0) __PYX_ERR(0, 309, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Find identical blocks in two strings.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_7matching_blocks, 0, __pyx_n_s_matching_blocks, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__21)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 354, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_matching_blocks, __pyx_t_1) < 0) __PYX_ERR(0, 354, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Subtract an edit subsequence from a sequence.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_9subtract_edit, 0, __pyx_n_s_subtract_edit, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__23)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 441, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_subtract_edit, __pyx_t_1) < 0) __PYX_ERR(0, 441, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Apply a sequence of edit operations to a string.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_15cpp_levenshtein_11apply_edit, 0, __pyx_n_s_apply_edit, NULL, __pyx_n_s_cpp_levenshtein, __pyx_d, ((PyObject *)__pyx_codeobj__25)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 508, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_apply_edit, __pyx_t_1) < 0) __PYX_ERR(0, 508, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_inverse_line_212, __pyx_kp_u_Invert_the_sense_of_an_edit_ope) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_editops_line_266, __pyx_kp_u_Find_sequence_of_edit_operation) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_opcodes_line_309, __pyx_kp_u_Find_sequence_of_edit_operation_2) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_matching_blocks_line_354, __pyx_kp_u_Find_identical_blocks_in_two_st) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_subtract_edit_line_441, __pyx_kp_u_Subtract_an_edit_subsequence_fr) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_1, __pyx_kp_u_apply_edit_line_508, __pyx_kp_u_Apply_a_sequence_of_edit_operat) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
