...
def build(setup_kwargs: Dict[str, Any]) -> None:
    ...
    src_dir = Path(skbuild.constants.CMAKE_INSTALL_DIR()) / "src" / "Levenshtein"
    dest_dir = Path("extern/Levenshtein")
    build_files(dest_dir, src_dir)
    ...
    build_files(build_src_dir, src_dir)
